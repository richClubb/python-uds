...
class RDBITestCase(unittest.TestCase):
    ...
    def test_rdbiSingleDIDAsciiResponse(self,
        ...
        self.assertEqual({'ECU Serial Number':[0x00]}, b)  # ... not set with a real return value yet!!! (returns a dict or a tuple of dicts if multiple DIDs requested)
    ...
    def test_rdbiSingleDIDMixedResponse(self,
        ...
        self.assertEqual({'Boot Software Identification':[0x00],'numberOfModules':[0x00]}, b)  # ... not set with a real return value yet!!! (returns a dict or a tuple of dicts if multiple DIDs requested)
