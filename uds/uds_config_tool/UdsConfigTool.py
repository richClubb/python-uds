...
from uds.uds_config_tool.ISOStandard.ISOStandard import IsoServices, IsoRoutineControlType, \
    IsoInputOutputControlOptionRecord, IsoReadDTCSubfunction, IsoReadDTCStatusMask as Mask
...
if __name__ == "__main__":
    ...
    a.routineControl('Erase Memory', IsoRoutineControlType.startRoutine,
                     [('memoryAddress', [0x01]), ('memorySize', [0xF000])])
    a.requestDownload(FormatIdentifier=[0x00], MemoryAddress=[0x40, 0x03, 0xE0, 0x00],
